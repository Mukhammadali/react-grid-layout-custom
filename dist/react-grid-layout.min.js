    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[D] = k[p] = k[j] = k[f] = k[h] = k[d] = k[g] = k[
            m
        ...
        function Pt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : z).test(Yt(t))
          );
          var e;
        }
        function Mt(t) {
      ...
      var p = (function(t) {
        ...
        return (
          ...
          (e.prototype.onDrag = function(t, e, n, r) {
            var o = r.e,
              a = r.node,
              i = (r.newPosition, r.animatePlaceholder),
            ...
            if (p) {
              ...
              (l = (0, u.moveElement)(
                ...
                this.props.onDrag(l, s, p, h, o, a),
                this.setState({
                  layout: (0, u.compact)(l, this.compactType(), c),
                  activeDrag: h,
                  showPlaceholder: f
                });
            }
        ...
        return (
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                var f = e.calcXY(u.top, u.left),
                  h = f.x,
                  d = f.y,
                  y = null == e.props.continueDrag || e.state.handedOffDrag;
                return s.call(e, e.props.i, h, d, {
                  e: n,
                  node: o,
                  newPosition: u,
                  animatePlaceholder: y
                });
              }
            };
          }),
          ...
          (e.prototype.componentDidMount = function() {
            if (this.props.continueDrag) {
              var t = a.default.findDOMNode(this.refs.draggable),
                e = t.getBoundingClientRect();
              if ("mousemove" === this.props.continueDrag.type) {
                var n = {
                ...
                this.refs.draggable.onMouseDown(n);
              } else if ("touchmove" === this.props.continueDrag.type) {
                var r = {
                  type: this.props.continueDrag.type,
                  target: t,
                  targetTouches: [
                    new Touch({
                      identifier: this.props.continueDrag.targetTouches[0]
                        .identifier,
                      target: t,
                      clientX: e.left,
                      clientY: e.top
                ...
                this.refs.draggable.onTouchStart(r);
              }
            }
          }),
          (e.prototype.componentDidUpdate = function() {
            if (this.props.continueDrag && !this.state.handedOffDrag) {
              ...
              this.refs.draggable.handleDrag(e),
                this.setState({ handedOffDrag: !0 });
            }
          }),
          e
        );
