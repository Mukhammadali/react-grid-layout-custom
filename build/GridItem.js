...
var GridItem = function (_React$Component) {
  ...
  GridItem.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    var droppingPosition = nextProps.droppingPosition;
    ...
    } else if (dragging && droppingPosition.x !== this.props.droppingPosition.x || droppingPosition.y !== this.props.droppingPosition.y) {
  ...
  GridItem.prototype.onDragHandler = function onDragHandler(handlerName) {
    ...
    return function (e, _ref2) {
        ...
        case "onDragStart":
          {
            ...
            _this2.state.dragging = newPosition;
      ...
      var animatePlaceholder = _this2.props.continueDrag == null || _this2.state.handedOffDrag;
  ...
  GridItem.prototype.render = function render() {
    ...
    var newChild = _react2.default.cloneElement(child, {
      className: (0, _classnames2.default)("react-grid-item", child.props.className, this.props.className, {
        ...
        cssTransforms: useCSSTransforms && (!this.props.continueDrag || this.state.handedOffDrag)
      }),
  ...
  GridItem.prototype.componentDidMount = function componentDidMount() {
    if (this.props.continueDrag) {
      var draggableElement = _reactDom2.default.findDOMNode(this.refs.draggable);
      var boundingRect = draggableElement.getBoundingClientRect();
      if (this.props.continueDrag.type === "mousemove") {
        ...
        // Start drag as if it's in the auto-placed position
        this.refs.draggable.onTouchStart(_new_event);
      }
    }
  };
